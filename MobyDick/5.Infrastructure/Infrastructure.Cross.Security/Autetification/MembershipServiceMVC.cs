...
namespace Infrastructure.Cross.Security.Autetification
{
    public class MembershipServiceMVC : IMembershipService
    {
        ...
        public bool Login(string userName, string password, bool persistCookie = false)
        {
            ...
            //var a = ((SimpleMembershipProvider)System.Web.Security.Membership.Provider).GetUser("Sebas", false);
            //a.IsApproved = false;

            //((SimpleMembershipProvider)System.Web.Security.Membership.Provider).UpdateUser(a);
